...
namespace TSviewACD
{
    public class SenderBreakCanceledException : OperationCanceledException
    {
    ...
    public class PlayEOF_CanceledException : OperationCanceledException
    {
    }
    ...
    public class UDP_TS_Stream : Stream
    {
        ...
        public class UDPSender
        {
            ...
            int packetlen = 188 * Config.SendPacketNum;
            byte[] packet;
            int packet_last;
            bool init_TOT;
            long Position;
